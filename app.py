...
vn.connect_to_sqlite('C:\\Users\\modip\\Desktop\\sql_ai\\hacknuthon24-abhimanyu\\Chinook.sqlite')
...
# Call the function with the provided DDL
# create_sqlite_file(ddl)
...
# Check if GPU is available
    ...
    # create_sqlite_file(request.json['ddl'])
