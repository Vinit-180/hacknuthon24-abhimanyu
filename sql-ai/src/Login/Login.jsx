  ...
  return (
    <>
      <div className=" flex h-screen w-100 items-center justify-center ">
        {login ?<div className="flex  border border-solid border-gray-700 rounded gap-10">
          <form action="" className="col-md-6 rounded px-8 pt-6 pb-8 mb-4 " onSubmit={handleSubmit(submit)}>
        ...
        </div> : <div className="flex  border border-solid border-gray-700 rounded gap-10">
          <form action="" className="col-md-6 rounded px-8 pt-6 pb-8 mb-4 ">
